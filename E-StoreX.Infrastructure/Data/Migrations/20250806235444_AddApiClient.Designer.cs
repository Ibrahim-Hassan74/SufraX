...
namespace EStoreX.Infrastructure.Migrations
{
    ...
    [Migration("20250806235444_AddApiClient")]
    partial class AddApiClient
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EStoreX.Core.Domain.Entities.ApiClient", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Entities.Address", b =>
                {
                    b.HasOne("EStoreX.Core.Domain.IdentityEntities.ApplicationUser", "ApplicationUser")
                        .WithOne("Address")
                        .HasForeignKey("Domain.Entities.Address", "ApplicationUserId")
